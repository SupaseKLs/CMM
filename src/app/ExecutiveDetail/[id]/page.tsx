...
const UserProfile: React.FC = () => {
    ...
    return (
        <div className='bg-white'>
            ...
            <div className="mt-20">
                <div className="h-full bg-white hidden md:grid grid-cols-[80%_20%]">
                    <div className='flex flex-col justify-center text-center w-6/12 mx-auto'>
                ...
                <div className='hidden md:block h-full bg-gray-100'>
                    <div className="w-11/12 mx-auto">
                        <div className="flex pt-40">
                            <div>
                                <h1 className='text-3xl border-2 px-6 py-3 border-black rounded-full'>ประวัติการศึกษา</h1>
                            </div>
                            <div className='pl-96'>
                                <p className='w-[700px] text-4xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos assumenda ipsum est harum pariatur velit, voluptas necessitatibus impedit magnam nobis aliquam dolorum nemo, rem quasi quidem. Minus cumque temporibus vero.</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-10">
                            {[
                                ...
                                <div key={index} className='my-20 relative bg-white rounded-xl h-96'>
                ...
                <div className='md:block hidden bg-black h-full'>
                    <div className="w-11/12 mx-auto">
                        <div className="flex justify-between py-20">
                            ...
                            <div>
                                <div className='text-white'>
                                    ...
                                    <p className='text-2xl pt-8 w-[700px]'>{safeGet(user?.work_experience?.first?.position || '')}</p>
                                </div>
                                <div className='pt-20 text-white'>
                                    <h1 className='text-4xl'>
                                        {safeGet(user?.work_experience?.second?.period || '')}
                                    </h1>
                                    <p className='text-2xl pt-8 w-[700px]'>{safeGet(user?.work_experience?.second?.position || '')}</p>
                                </div>
                            </div>
                        </div>

                        <div className='py-20 flex justify-between text-white'>
                            <div>
                    ...
                    <div className='block lg:hidden h-full py-20 bg-white'>
                        <div className="w-11/12 mx-auto">
                ...
                {/* Mobile */}
                <div className="w-11/12 mx-auto h-full block md:hidden bg-white">
                    <div>
                        <div>
                            <h1 className='pt-12 text-xl'>ชื่อ</h1>
                            <h1 className='border-b-2 border-black text-2xl font-semibold pb-2'>ผศ.ดร. ชนินทร์ ตั้งพานทอง</h1>
                        </div>
                        <div>
                            <h1 className='pt-12 text-xl'>ตำแหน่ง</h1>
                    ...
                    <div className='flex flex-col justify-center text-center py-20 w-11/12 mx-auto'>
                ...
                <div className='block md:hidden h-full bg-gray-100'>
                    <div className="w-11/12 mx-auto">
                        <div className="pt-40">
                            <h1 className='text-2xl border-2 px-6 py-3 border-black rounded-full'>ประวัติการศึกษา</h1>
                            <p className='w-11/12 pt-8 text-4xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos assumenda ipsum est harum pariatur velit, voluptas necessitatibus impedit magnam nobis aliquam dolorum nemo, rem quasi quidem. Minus cumque temporibus vero.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            {[
                                ...
                                <div key={index} className='my-2 relative bg-white rounded-xl h-96'>
                                    <div className="absolute bottom-0 pb-8 pl-6">
                                        <h1 className='text-4xl font-semibold'>{edu.level}</h1>
                                        <h1 className='text-xl'>{safeGet(edu.university || '')}</h1>
                                        <p>{safeGet(edu.field || '')}</p>
            ...
            <div className='block md:hidden bg-black h-full'>
                <div className="w-11/12 mx-auto">
                    <div className="py-20">
                        <div className='text-5xl text-white'>
                            <h1>ประวัติการทำงาน</h1>
                        ...
                        <div>
                            <div className='text-white pt-10'>
                                ...
                                <p className='text-2xl pt-8 w-11/12'>{safeGet(user?.work_experience?.first?.position || '')}</p>
                            </div>
                            <div className='pt-20 text-white'>
                                <h1 className='text-4xl'>
                                    {safeGet(user?.work_experience?.second?.period || '')}
                                </h1>
                                <p className='text-2xl pt-8 w-11/12'>{safeGet(user?.work_experience?.second?.position || '')}</p>
                            </div>
                        </div>
                    </div>

                    <div className='py-20 grid grid-cols-2 justify-between text-white'>
                        <div>
                            <h1 className='text-8xl'>60+</h1>
                            <p className='text-3xl'>Projects</p>
                        </div>
