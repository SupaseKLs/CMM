...
export default function Bacheror() {
    return (
        <section className="bg-white">
            <div>
                <Image src={Student} className="h-screen" alt="bacheror_multi" />
            </div>
            ...
            <div className="w-11/12 mx-auto">
                <div className="py-32 flex flex-col md:flex-row justify-between">
                    ...
                    <div className="pt-10 md:pt-0 text-2xl w-full md:w-[40%]">
                ...
                <div className="flex justify-center">
                    <div className="bg-white shadow-2xl flex flex-col justify-center w-full 2xl:w-[60%] lg:flex-row rounded-2xl">
                        <div className="w-full lg:w-full 2xl:w-[60%]">
                            <Image
                                src={Student}
                                className="rounded-2xl w-full 2xl:w-auto h-auto 2xl:h-full"
                                alt="student"
                            />
                        </div>
                        <div className="h-full px-5 pt-4 w-full">
                            <div>
                                <h1 className="font-bold text-xl md:text-2xl 2xl:text-4xl pb-6">
                                    ชื่อปริญญาและสาขาวิชา
                                </h1>
                                <div className="grid grid-rows-2">
                                    <div
                                        className="text-sm md:text-md 2xl:text-xl grid"
                                        style={{ gridTemplateColumns: "20% 37% 1fr" }}
                                    >
                                        <div>
                                            <h1>ชื่อเต็ม</h1>
                                        </div>
                                ...
                                <div className="pt-4 text-sm md:text-md grid grid-rows-2">
                                    <div
                                        className="text-sm md:text-md 2xl:text-xl grid"
                                        style={{ gridTemplateColumns: "20% 37% 43%" }}
                                    >
                                        <div>
                                            <h1>ชื่อย่อ</h1>
                                        </div>
                            ...
                            <div className="py-6">
                                ...
                                <ul className="text-sm md:text-md 2xl:text-xl">
                                    {[
                                        ["หมวดวิชาเลือกศึกษาทั่วไป", 31],
                                        ["หมวดวิชาเสรี", 6],
                                        ["หมวดวิชาเฉพาะ", 101],
                                        ["รวม", 138],
                                    ].map(([label, credit], idx) => (
                                        <li
                                            key={idx}
                                            className="grid"
                                            style={{ gridTemplateColumns: "58% 10% 1fr" }}
                                        >
                                            <div>{label}</div>
                                            <div>{credit}</div>
                                            <div>หน่วยกิต</div>
                ...
                <div className="min-h-screen p-8">
                    <h1 className="text-4xl 2xl:text-5xl font-bold mt-10 md:mt-32 mb-12">หลักสูตรการศึกษา</h1>
                    {/* ตารางหมวดวิชา */}
                    <div className="rounded-lg border shadow-sm">
                        <Table className="text-sm md:text-md 2xl:text-xl">
                            <TableHeader>
                                {/* Mobile: 2 columns */}
                ...
                <div className="my-20">
                    <div className="uppercase font-bold">
                        <h1 className="text-7xl">Future</h1>
                        <h1 className="text-7xl pl-60">Careers</h1>
