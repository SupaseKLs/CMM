                ...
                <div className='w-11/12 mx-auto'>
                    <div className="flex justify-between py-20">
                        <div className='w-[40%] relative'>
                            <div>
                                <NumberTicker className="font-Poppins text-7xl md:text-8xl font-bold text-purple-700" value={20} />
                            </div>
                            <div className='absolute left-0 pl-32 pt-4 top-0 text-purple-700 font-semibold'>
                    ...
                    <div className="pb-40 grid grid-cols-5 font-bold">
                        <div className='relative'>
                            <div>
                                <NumberTicker className="font-Poppins text-7xl md:text-8xl text-black" value={50} />
                            </div>
                            <div className='absolute left-0 pl-32 pt-4 top-0 text-black font-semibold'>
                                <h1>3d<br />designers</h1>
                            </div>
                        </div>
                        <div className='relative'>
                            <div>
                                <NumberTicker className="font-Poppins text-7xl md:text-8xl text-black" value={80} />
                            </div>
                            <div className='absolute left-0 pl-32 pt-4 top-0 text-black font-semibold'>
                        ...
                        <div className='relative'>
                            <div>
                                <NumberTicker className="font-Poppins text-7xl md:text-8xl text-black" value={30} />
                            </div>
                            <div className='absolute left-0 pl-32 pt-4 top-0 text-black font-semibold'>
                        ...
                        <div className='relative'>
                            <div>
                                <NumberTicker className="font-Poppins text-7xl md:text-8xl text-black" value={24} />
                            </div>
                            <div className='absolute left-0 pl-32 pt-4 top-0 text-black font-semibold'>
                        ...
                        <div className='relative'>
                            <div>
                                <NumberTicker className="font-Poppins text-7xl md:text-8xl text-black" value={84} />
                            </div>
                            <div className='absolute left-0 pl-32 pt-4 top-0 text-black font-semibold'>
